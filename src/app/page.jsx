 ...
 rounded-3xl shadow gap-2.5 shadow-gray-500 leading-[14px] grid "
      >
        ...
        <span className=" mx-5 text-black text-sm text-justify ">
          É o software responsável pelo gerenciamento completo do seu negócio de
          barbearia! Aqui o enfoque total é direcionado a atender suas demandas
          com responsabilidade e atenção. Assim, podemos ser seu app de gestão
